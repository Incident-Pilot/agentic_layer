...
from incident_pilot_agent.graph.state import PHASE_POSTMORTEM_GENERATED
...
async def test_cascading_failure_fixture_requires_a_rejection_and_replan_cycle(tmp_path):
    ...
    # into the remediation planner and then the post-mortem agent -- see
    # test_remediation_planner.py for the dedicated actionable-vs-not
    # routing tests.
